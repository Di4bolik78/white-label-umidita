    ...
    <section className="relative min-h-[90vh] md:min-h-screen flex overflow-hidden">
      ...
      <div className="relative z-10 w-full md:w-[45%] bg-white/60 md:bg-white/75 backdrop-blur-sm flex items-center">
        <div className="p-6 pt-24 md:p-12 md:pt-28 md:pl-16 lg:p-16 lg:pt-32 lg:pl-20 w-full stagger-children">
          ...
          <p className="text-[#333333] font-medium text-base md:text-lg mb-3 md:mb-4 tracking-wide">
          ...
          <p className="text-[#333333] text-base md:text-lg lg:text-xl mb-6 md:mb-8 leading-relaxed">
